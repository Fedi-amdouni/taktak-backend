...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS estimated_wait_minutes INTEGER;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS estimated_ready_at TIMESTAMP;
ALTER TABLE orders ADD COLUMN IF NOT EXISTS participant_id VARCHAR(64);
ALTER TABLE orders ADD COLUMN IF NOT EXISTS client_order_id VARCHAR(64);
CREATE UNIQUE INDEX IF NOT EXISTS uq_orders_cafe_client_order
    ON orders(cafe_id, client_order_id)
    WHERE client_order_id IS NOT NULL;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS ordering_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS waiter_calls_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS games_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS ambiance_voting_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS rewards_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS tv_menu_enabled BOOLEAN NOT NULL DEFAULT TRUE;
ALTER TABLE cafes ADD COLUMN IF NOT EXISTS tv_menu_style VARCHAR(32) NOT NULL DEFAULT 'ELEGANT';
